...
AUTO_ADD_GLOBAL_DEFINE_BY_NAME=MTK_ACMT_DEBUG MTK_BT_PROFILE_AVRCP MTK_NVRAM_SECURITY MTK_MMPROFILE_SUPPORT MTK_GPS_SUPPORT MTK_MULTIBRIDGE_SUPPORT MTK_GEMINI_4SIM_SUPPORT EVDO_DT_SUPPORT MTK_CAMCORDER_PROFILE_MID_MP4 MTK_FM_SUPPORT MTK_USES_HD_VIDEO MTK_TABLET_PLATFORM MTK_WORLD_PHONE MTK_DUAL_MIC_SUPPORT MTK_AUTO_DETECT_MAGNETOMETER MTK_AUDIO_ADPCM_SUPPORT MTK_GEMINI_SMART_3G_SWITCH CUSTOM_KERNEL_OFN MTK_BT_PROFILE_MANAGER MTK_RMVB_PLAYBACK_SUPPORT MTK_TER_SERVICE MTK_TVOUT_SUPPORT MTK_FM_RECORDING_SUPPORT PURE_AP_USE_EXTERNAL_MODEM MTK_DEDICATEDAPN_SUPPORT MTK_LCA_SUPPORT MTK_AUD_LOCK_MD_SLEEP_SUPPORT MTK_NFC_SE_NUM MTK_IPV6_SUPPORT MTK_CTP_RESET_CONFIG MTK_STEREO3D_WALLPAPER_APP MTK_MATV_SERIAL_IF_SUPPORT MTK_BT_FM_OVER_BT_VIA_CONTROLLER MTK_BT_PROFILE_PBAP MTK_FAT_ON_NAND MTK_BT_PROFILE_PAN MTK_BT_PROFILE_A2DP MTK_BT_PROFILE_HFP MTK_BT_PROFILE_AVRCP14 MTK_VOICE_UI_SUPPORT MTK_MASS_STORAGE MTK_BICR_SUPPORT MTK_SEC_VIDEO_PATH_SUPPORT MTK_BT_PROFILE_BIP MTK_BT_PROFILE_BPP MTK_NCP1851_SUPPORT MTK_COMBO_QUICK_SLEEP_SUPPORT MTK_THEMEMANAGER_APP MTK_HDR_SUPPORT MTK_TMP103_SUPPORT MTK_DSPIRDBG MTK_TABLET_DRAM MTK_MT8193_SUPPORT MTK_MERGE_INTERFACE_SUPPORT HAVE_AACENCODE_FEATURE MTK_BT_PROFILE_MAPS MTK_FM_50KHZ_SUPPORT MTK_WIFI_HOTSPOT_SUPPORT MTK_TB_DEBUG_SUPPORT MTK_COMBO_SUPPORT MTK_BT_PROFILE_OPP MTK_IN_HOUSE_TEE_SUPPORT MTK_BT_PROFILE_SIMAP MTK_FLIGHT_MODE_POWER_OFF_MD MTK_RADIOOFF_POWER_OFF_MD MTK_BT_PROFILE_MAPC MTK_SHARED_SDCARD MTK_EMMC_DISCARD MTK_2IN1_SPK_SUPPORT MTK_DT_SUPPORT MTK_MDM_LAWMO MTK_DMNR_TUNING_AT_MD MTK_MULTI_STORAGE_SUPPORT MTK_WFD_SUPPORT MTK_CACHE_MERGE_SUPPORT MTK_MT8193_HDCP_SUPPORT MTK_ENABLE_VIDEO_EDITOR MTK_EAP_SIM_AKA MTK_YMAL_SCATTER_FILE_SUPPORT MTK_AUDIO_RAW_SUPPORT MTK_WAPI_SUPPORT MTK_FD_SUPPORT MTK_DISPLAY_HIGH_RESOLUTION HAVE_ADPCMENCODE_FEATURE MTK_WFD_VIDEO_FORMAT NAND_OTP_SUPPORT MTK_FACEBEAUTY_SUPPORT MTK_AAL_SUPPORT EVDO_DT_VIA_SUPPORT MTK_HANDSFREE_DMNR_SUPPORT MTK_MT8193_HDMI_SUPPORT MTK_YAML_SCATTER_FILE_SUPPORT MTK_BT_40_SUPPORT MTK_BT_PROFILE_FTP MTK_ASF_PLAYBACK_SUPPORT MTK_CAMERA_BSP_SUPPORT MTK_DVFS_DISABLE_LOW_VOLTAGE_SUPPORT MTK_HIGH_QUALITY_THUMBNAIL MTK_IPV6_TETHER_NDP_MODE MTK_FM_RX_SUPPORT MTK_IMAGE_LARGE_MEM_LIMIT MTK_FM_TX_SUPPORT MTK_MDM_FUMO MTK_OWNER_SDCARD_ONLY_SUPPORT MTK_BRAZIL_CUSTOMIZATION_VIVO MTK_BRAZIL_CUSTOMIZATION_CLARO MTK_ENABLE_MD2 MTK_INTERNAL_MHL_SUPPORT MTK_ENABLE_MD1 HAVE_XLOG_FEATURE MTK_LCA_RAM_OPTIMIZE IS_82VCORE_USE_6333VCORE MTK_NO_NEED_USB_LED MTK_BT_PROFILE_TIMES MTK_NATIVE_3D_SUPPORT MTK_SWCHR_SUPPORT MTK_BT_PROFILE_TIMEC MTK_VOICE_UNLOCK_SUPPORT MTK_UMTS_TDD128_MODE MTK_TETHERING_EEM_SUPPORT MTK_MATV_ANALOG_SUPPORT MTK_AUTORAMA_SUPPORT MTK_BSP_PACKAGE MTK_SIM_AUTHENTICATION_SUPPORT MTK_BRAZIL_CUSTOMIZATION CUSTOM_KERNEL_ACCELEROMETER MTK_BEAM_PLUS_SUPPORT MTK_BT_SUPPORT MTK_VT3G324M_SUPPORT MTK_CTA_SUPPORT MTK_KERNEL_POWER_OFF_CHARGING MTK_NFC_SUPPORT MTK_DFO_SUPPORT IS_82VM_USE_6333VM MTK_NAND_UBIFS_SUPPORT CUSTOM_KERNEL_GYROSCOPE MTK_MDM_SCOMO MTK_SIM_HOT_SWAP_COMMON_SLOT CUSTOM_KERNEL_MAGNETOMETER MTK_CTPPPOE_SUPPORT MTK_EMULATOR_SUPPORT MTK_BT_PROFILE_HIDH MTK_ION_SUPPORT MTK_AUTOIP_SUPPORT MTK_MT6333_SUPPORT MTK_PRODUCT_INFO_SUPPORT MTK_CAMERA_APP_3DHW_SUPPORT MTK_WLAN_SUPPORT MTK_PQ_SUPPORT MTK_TETHERINGIPV6_SUPPORT MTK_UART_USB_SWITCH MTK_IPOH_SUPPORT MTK_AUTO_DETECT_ACCELEROMETER HAVE_CMMB_FEATURE MTK_USES_VR_DYNAMIC_QUALITY_MECHANISM MTK_EMMC_SUPPORT_OTP MTK_LCA_ROM_OPTIMIZE MTK_TB_APP_CALL_FORCE_SPEAKER_ON MTK_COMBO_CORE_DUMP_SUPPORT MTK_TB_HW_DEBUG MTK_PLATFORM_OPTIMIZE MTK_MULTISIM_RINGTONE_SUPPORT TELEPHONY_DFOSET MTK_BIP_SCWS MTK_QVGA_LANDSCAPE_SUPPORT MTK_FM_SHORT_ANTENNA_SUPPORT MTK_SW_BTCVSD MTK_HDMI_HDCP_SUPPORT MTK_HDMI_SUPPORT MTK_GEMINI_3SIM_SUPPORT MTK_RILD_READ_IMSI MTK_INTERNAL_HDMI_SUPPORT MTK_BT_PROFILE_SPP MTK_BT_30_SUPPORT MTK_FAN5405_SUPPORT MTK_MT8193_NFI_SUPPORT MTK_DISABLE_POWER_ON_OFF_VOLTAGE_LIMITATION MTK_HW_ENHANCE MTK_SHOW_MSENSOR_TOAST_SUPPORT MTK_LCEEFT_SUPPORT MTK_WVDRM_L1_SUPPORT MTK_AUDIO_CHANGE_SUPPORT MTK_BT_21_SUPPORT MTK_BT_PROFILE_DUN MTK_DHCPV6C_WIFI MTK_BT_PROFILE_PRXM MTK_FSCK_MSDOS_MTK MTK_MAV_SUPPORT MTK_IPV6_TETHER_PD_MODE HAVE_AWBENCODE_FEATURE MTK_BQ24196_SUPPORT MTK_WEB_NOTIFICATION_SUPPORT MTK_MD_SHUT_DOWN_NT MTK_SPH_EHN_CTRL_SUPPORT MTK_WB_SPEECH_SUPPORT CUSTOM_KERNEL_ALSPS MTK_VIBSPK_SUPPORT IS_82VRF18_USE_6333VRF18 MTK_BT_PROFILE_PRXR ENCRY_PARTITION_SUPPORT MTK_DRM_KEY_MNG_SUPPORT MTK_BQ27541_SUPPORT MTK_SD_REINIT_SUPPORT MTK_SENSOR_SUPPORT MTK_M4U_SUPPORT MTK_EMMC_SUPPORT MTK_VOIP_ENHANCEMENT_SUPPORT MTK_S3D_SUPPORT MTK_2SDCARD_SWAP MTK_WLANBT_SINGLEANT CONFIG_DL_CHECK_SUPPORT CONTROL_SAVELOG_SUPPORT MTK_AUTO_DETECT_ALSPS HW_LCD_BIAS_VOL MTK_BACK_CAMERA_8M MTK_FRONT_CAMERA_5M
AUTO_ADD_GLOBAL_DEFINE_BY_NAME_VALUE=MTK_SIM1_SOCKET_TYPE MTK_TOUCH_PHYSICAL_ROTATION_RELATIVE_TO_LCM MTK_LCM_PHYSICAL_ROTATION MTK_NEON_SUPPORT EMMC_CHIP CUSTOM_KERNEL_SSW MTK_SINGLE_3DSHOT_SUPPORT MTK_EXTERNAL_MODEM_SLOT MTK_SHARE_MODEM_SUPPORT MTK_PCB_BATTERY_SENSOR LCM_HEIGHT MTK_SHARE_MODEM_CURRENT CUSTOM_KERNEL_MAIN2_IMGSENSOR LCM_WIDTH MTK_SIM2_SOCKET_TYPE
...
CUSTOM_HAL_IMGSENSOR = ov5648_mipi_raw s5k4e1ga_mipi_raw imx134liteon_mipi_raw imx134sunny_mipi_raw
...
CUSTOM_HAL_MAIN_IMGSENSOR = imx134liteon_mipi_raw imx134sunny_mipi_raw
...
# Enable CMMB for 6515/6517 TDD Projects. Make sure resolve the CR [ALPS00288876] to remove the dependency between CMMB feature option and OP01 firstly, or else there will be dependency check error.
CUSTOM_KERNEL_CMMB=
...
CUSTOM_KERNEL_IMGSENSOR = ov5648_mipi_raw s5k4e1ga_mipi_raw imx134liteon_mipi_raw imx134sunny_mipi_raw
...
CUSTOM_KERNEL_MAGNETOMETER=akm09911_hw
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = imx134liteon_mipi_raw imx134sunny_mipi_raw
# lens driver config for main camera
...
CUSTOM_KERNEL_SUB_IMGSENSOR = ov5648_mipi_raw s5k4e1ga_mipi_raw
# lens driver config for video telephony camera
...
DFO_BOOT=MTK_ENABLE_MD1 MTK_ENABLE_MD2 MD1_SIZE MD2_SIZE MD1_SMEM_SIZE MD2_SMEM_SIZE MTK_MD1_SUPPORT MTK_MD2_SUPPORT
DFO_DEFINE=MTK_DFO_TEST1 MTK_DFO_TEST2 MTK_DT_SUPPORT MTK_TELEPHONY_MODE MTK_SHARE_MODEM_SUPPORT MTK_SHARE_MODEM_CURRENT MTK_ENABLE_MD1 MTK_ENABLE_MD2 MTK_FIRST_MD
...
# Disable 82VCORE_USE_6333VCORE.
IS_82VCORE_USE_6333VCORE=no

# Disable 82VM_USE_6333VM.
IS_82VM_USE_6333VM=no

# Disable 82VRF18_USE_6333VRF18.
IS_82VRF18_USE_6333VRF18=no
...
# one load to support different plsensor sensor
...
# Temp for Marketing requirement.
MTK_CUSTOM_720P=no
...
# Multiuser for 3gdata_sms and Multiuser with External .
...
MTK_PRODUCT_AAPT_CONFIG=xhdpi hdpi
...
MTK_RELEASE_PACKAGE=rel_customer_basic rel_customer_platform rel_customer_operator_cmcc rel_customer_advanced
MTK_RESOURCE_OPTIMIZATION=
MTK_RILD_READ_IMSI=no

# use  to wrap the RMVB playback feature, AS 75 do not supporte the RMVB Playback, so set no
...
# For SIM hot swap feature with common slot HW design.
...
# Use for control Telephony Early Read (TER) Service
# default value is no,each project can be turned on  by demand .
MTK_TER_SERVICE=no
...
# Support the 3-in-1 speaker HW.  The speaker can be used as receiver, loud speaker, and vibrator.
...
# VoIP receiver mode DMNR support.
...
# WFD video resolution support many resolution, such as CEA/CESA/HH etc.. Add one configuration to control the default video resolution of WFD.
...
RESOURCE_OVERLAY_SUPPORT=generic navbar qHD 730t_define
...
LCM_WIDTH=720
#Do not support zh_TW in China main land.
...
#To choose download check function
CONFIG_DL_CHECK_SUPPORT=yes
CONTROL_SAVELOG_SUPPORT=yes
HW_APKINSTALL_APP=yes
...
HW_GPMS_SUPPORT=no
HW_GLOBAL_ECC_SUPPORT=no
HW_SETTINGS_SUPPORT=no
HW_POCKET_MODE_SUPPORT=yes

#set bias vol
HW_LCD_BIAS_VOL=yes
MTK_BACK_CAMERA_8M=yes
MTK_FRONT_CAMERA_5M=yes
MTK_MMS_SUPPORT=yes
