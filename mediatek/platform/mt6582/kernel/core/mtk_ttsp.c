...
void cyttsp4_mtk_gpio_interrupt_register()
{
	...
	mt_eint_registration(CUST_EINT_TOUCH_PANEL_NUM, CUST_EINTF_TRIGGER_FALLING, eint_interrupt_handler, 1);
		...
		struct kobj_attribute *attr, char *buf)
{
	return sprintf(buf,
		__stringify(EV_KEY) ":"
		__stringify(KEY_BACK) ":90:1000:160:60"
		":" __stringify(EV_KEY) ":"
		__stringify(KEY_HOMEPAGE) ":270:1000:160:60"
		":" __stringify(EV_KEY) ":"
		__stringify(KEY_MENU) ":450:1000:160:60"
		"\n");
}
...
#include <linux/Ofilm_R300_config.h>
...
#include <linux/Truely_R300_config.h>
...
static struct cyttsp4_core_info cyttsp4_R300_core_info = {
