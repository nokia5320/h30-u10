...
#define IMX134MIPI_REAL_PV_WIDTH				1632//1640
#define IMX134MIPI_REAL_PV_HEIGHT				1224//1232
/* Real CAP Size, i.e. the size after all ISP processing (so already -4/-6), before MDP. */
#define IMX134MIPI_REAL_CAP_WIDTH				3264//3280
#define IMX134MIPI_REAL_CAP_HEIGHT			2448//2464
#define IMX134MIPI_REAL_VIDEO_WIDTH			3272 //3280-8
#define IMX134MIPI_REAL_VIDEO_HEIGHT		1846 //1852-6  //1660  size 3280 X 1664  //1082 size for 1920 X 1088

/* X/Y Starting point */
#define IMX134MIPI_IMAGE_SENSOR_PV_STARTX       2
#define IMX134MIPI_IMAGE_SENSOR_PV_STARTY       2	// The value must bigger or equal than 1.
#define IMX134MIPI_IMAGE_SENSOR_CAP_STARTX		4   //(IMX134MIPI_IMAGE_SENSOR_PV_STARTX * IMAGE_SENSOR_H_DECIMATION)
#define IMX134MIPI_IMAGE_SENSOR_CAP_STARTY		4   //(IMX134MIPI_IMAGE_SENSOR_PV_STARTY * IMAGE_SENSOR_V_DECIMATION)		// The value must bigger or equal than 1.
#define IMX134MIPI_IMAGE_SENSOR_VIDEO_STARTX       2
#define IMX134MIPI_IMAGE_SENSOR_VIDEO_STARTY       2	// The value must bigger or equal than 1.
