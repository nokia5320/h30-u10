...
{
        /*Delete the redundant opration to the registers*/
...
static void MT9V113MIPI_YUV_sensor_initial_setting(void)
{
    ...
    printk("MT9V113MIPI_Initial_Setting!!!\n");
		...
		MT9V113MIPI_write_cmos_sensor(0x0014, 0x2145);
        MT9V113MIPI_write_cmos_sensor(0x0010, 0x042B);
    ...
    count=5;
		...
		MT9V113MIPI_write_cmos_sensor(0x0990, 0x006B);
        MT9V113MIPI_write_cmos_sensor(0x098C, 0x271F);
        MT9V113MIPI_write_cmos_sensor(0x0990, 0x025B);
        MT9V113MIPI_write_cmos_sensor(0x098C, 0x2721);
        MT9V113MIPI_write_cmos_sensor(0x0990, 0x034A);
        ...
        MT9V113MIPI_write_cmos_sensor(0x0990, 0x008A);
        MT9V113MIPI_write_cmos_sensor(0x098C, 0xA408);
        MT9V113MIPI_write_cmos_sensor(0x0990, 0x0021);
        ...
        MT9V113MIPI_write_cmos_sensor(0x0990, 0x0028);
...
UINT32 MT9V113MIPIOpen(void)
{
    ...
    MT9V113MIPI_set_param_banding(AE_FLICKER_MODE_50HZ);
...
static kal_uint32 MT9V113MIPI_GetSensorID(kal_uint32 *sensorID)
{
    ...
    {
         SENSORDB("MT9V113MIPI_GetSensorID  searchMainSensor = KAL_TRUE!\n ");
        *sensorID = 0xFFFFFFFF;
        return ERROR_SENSOR_CONNECT_FAIL;
    }
