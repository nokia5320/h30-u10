...
extern LCM_DRIVER nt35590_hd720_dsi_cmd_auo_hvga_lcm_drv;
...
//add trulu lcm driver
extern LCM_DRIVER truly_nt35516_lcm_drv;
//add tianma otm9605a lcm driver
extern LCM_DRIVER tianma_otm9605a_lcm_drv;
extern LCM_DRIVER nt35517_qhd_vdo_boe55_lcm_drv;
extern LCM_DRIVER nt35517_qhd_vdo_byd55_lcm_drv;
extern LCM_DRIVER nt35517_qhd_vdo_auo55_lcm_drv;
//otm9605a LCD replace
extern LCM_DRIVER otm9605a_qhd_vdo_auo55_lcm_drv;
extern LCM_DRIVER cmi_otm1282a_hd720_dsi_cmd_lcm_drv;
extern LCM_DRIVER auo_otm1282a_hd720_dsi_cmd_lcm_drv;
//add tianma otm9605a lcm driver for G6
extern LCM_DRIVER otm9605a_qhd_vdo_tm_lcm_drv;
extern LCM_DRIVER nt35517_qhd_vdo_boe_lcm_drv;
extern LCM_DRIVER hx8389b_qhd_vdo_truly_lcm_drv;
...
{ 
...
#if defined(NT35590_HD720_DSI_CMD_AUO_HVGA)
	&nt35590_hd720_dsi_cmd_auo_hvga_lcm_drv,
#endif
...
#endif
#if defined(NT35517_QHD_VDO_BOE55)
    &nt35517_qhd_vdo_boe55_lcm_drv,
#endif
#if defined(NT35517_QHD_VDO_BYD55)
    &nt35517_qhd_vdo_byd55_lcm_drv,
#endif
#if defined(NT35517_QHD_VDO_AUO55)
    &nt35517_qhd_vdo_auo55_lcm_drv,
#endif
#if defined(OTM9605A_QHD_VDO_AUO55)
    &otm9605a_qhd_vdo_auo55_lcm_drv,
#endif
  ...
  &nt35520_hd720_tm_lcm_drv,
    ...
    &cmi_otm1282a_hd720_dsi_cmd_lcm_drv,
    &auo_otm1282a_hd720_dsi_cmd_lcm_drv,
#endif
//add tianma otm9605a lcm driver for G6
#if defined(OTM9605A_QHD_VDO_TM)
    &otm9605a_qhd_vdo_tm_lcm_drv,
#endif
#if defined(NT35517_QHD_VDO_BOE)
    &nt35517_qhd_vdo_boe_lcm_drv,
#endif
#if defined(HX8389B_QHD_VDO_TRULY)
    &hx8389b_qhd_vdo_truly_lcm_drv,
#endif
};
...
Function:       which_lcd_module_triple
  Description:    read LCD ID PIN status,could identify three status:high?¡élow?¡éfloat
  Input:           none
  Output:         none
