...
MSDK_SENSOR_INIT_FUNCTION_STRUCT SensorList[] =
{
    ...
    RAW_INFO(IMX134_SENSOR_ID, SENSOR_DRVNAME_IMX134_MIPI_RAW,NULL), 
#endif
#if defined(IMX134LITEON_MIPI_RAW)
    RAW_INFO(IMX134LITEON_SENSOR_ID, SENSOR_DRVNAME_IMX134LITEON_MIPI_RAW, IMX134LITEON_CAM_CALGetCalData),
#endif

#if defined(IMX134SUNNY_MIPI_RAW)
    RAW_INFO(IMX134SUNNY_SENSOR_ID, SENSOR_DRVNAME_IMX134SUNNY_MIPI_RAW, IMX134SUNNY_CAM_CALGetCalData),
#endif
...
#endif
//move ov5647mipiraw  and Hi542 before s5k4e1 for half high level during power-up
...
#endif
//move hi542 before s5k4e1 for half high level during power-up
...
#endif
//move ov5647mipiraw before s5k4e1 for half high level during power-up
...
#endif
#if defined(MT9V113_MIPI_YUV)
    YUV_INFO(MT9V113_MIPI_SENSOR_ID, SENSOR_DRVNAME_MT9V113MIPI_YUV, NULL),
#endif
