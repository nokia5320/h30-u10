...
FLASH_PROJECT_PARA& cust_getFlashProjectPara(int aeMode, NVRAM_CAMERA_STROBE_STRUCT* nvrame)
{
    ...
    //max duty is 32, max step is 8. Actually, step is not used.
	para.dutyNum = 32;
	para.stepNum = 8;
	//tuning
	...
	para.engLevel.torchDuty = 5;//Decrease the torh duty
	para.engLevel.torchStep = 1;

	//af
	para.engLevel.afEngMode = ENUM_FLASH_ENG_INDEX_MODE;
	para.engLevel.afDuty = 5;//old value 8 //af duty change
	para.engLevel.afStep = 1;// old value 7 //max step change

	//pf, mf, normal
	para.engLevel.pmfEngMode = ENUM_FLASH_ENG_INDEX_MODE;
	para.engLevel.pfDuty = 5; //4;  //increase the prelight 
	para.engLevel.mfDutyMax = 11;//max duty change
	para.engLevel.mfDutyMin = 5;
	para.engLevel.pmfStep = 1;// step change to 1

	//low bat
	para.engLevel.IChangeByVBatEn=0;
	para.engLevel.vBatL = 3400;	//mv
	para.engLevel.pfDutyL = 5;
	para.engLevel.mfDutyMaxL = 11;
	para.engLevel.mfDutyMinL = 5;
	para.engLevel.pmfStepL = 1;//max step is 1

	//burst setting
	para.engLevel.IChangeByBurstEn=1;
	para.engLevel.pfDutyB = 5;//duty change
	para.engLevel.mfDutyMaxB = 5;//max duty
	para.engLevel.mfDutyMinB = 5;
	...
	para.maxCapExpTimeUs = 100000;//max exp time:100ms
	/*
	//---------------
