...
#define CUST_EINT_EINT6_M_SENSOR_NUM              6
#define CUST_EINT_EINT6_M_SENSOR_DEBOUNCE_CN      0
#define CUST_EINT_EINT6_M_SENSOR_TYPE							CUST_EINTF_TRIGGER_HIGH
#define CUST_EINT_EINT6_M_SENSOR_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_DISABLE

#define CUST_EINT_NFC_NUM              11
...
#define CUST_EINT_MSDC1_INS_NUM              16
