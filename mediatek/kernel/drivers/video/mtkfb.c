...
static void mtkfb_shutdown(struct device *pdev)
{
	...
	is_early_suspended = TRUE;
	//merge patch ALPS.JB5.MP.V1_P125,stop dsi video mode,sovle the problem of the screen appears dodges probablly when restarting the test phone.
	DISP_PrepareSuspend();
...
//	mtkfb_clear_lcm();
    ...
    //merge patch ALPS.JB5.MP.V1_P125
    //trace_printk("[VR power] Display ENGINE OFF\n");
    MSG_FUNC_LEAVE();
}
#endif
...
//    UINT32 fbVirAddr = (UINT32)fbdev->fb_va_base + mtkfb_fbi->var.yoffset * mtkfb_fbi->fix.line_length;
    ...
    //merge patch ALPS.JB5.MP.V1_P125
    //trace_printk("[VR power] Display ENGINE ON\n");
    MSG_FUNC_LEAVE();
}
#endif
